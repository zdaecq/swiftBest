...
public class KCFloatingActionButton: UIView {
    ...
    */
    public var paddingX: CGFloat = 15 {
        didSet {
            self.setNeedsDisplay()
        }
    }
    public var paddingY: CGFloat = 15 {
        didSet {
            self.setNeedsDisplay()
        }
    }
	...
	*/
    ...
    /**
        Button color.
    */
    @IBInspectable public var buttonColor: UIColor = UIColor(red: 255/255.0, green: 127/255.0, blue: 0/255.0, alpha: 1)
    ...
    */
    @IBInspectable public var plusColor: UIColor = UIColor.whiteColor()
    ...
    */
     ...
     */
    @IBInspectable public var itemTitleColor: UIColor = UIColor(red: 255/255.0, green: 127/255.0, blue: 0/255.0, alpha: 1)
